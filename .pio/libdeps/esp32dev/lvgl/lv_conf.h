...
static void * lvgl_heap_alloc(size_t size) {
    return heap_caps_malloc(size, MALLOC_CAP_SPIRAM);
}

static void * lvgl_heap_realloc(void *ptr, size_t size) {
...
#define LV_MEM_CUSTOM 1
    ...
    #define LV_MEM_CUSTOM_ALLOC   lvgl_heap_alloc
 ...
 */
#define LV_LAYER_SIMPLE_BUF_SIZE          (24*1024)  // 24*1024  57600
#define LV_LAYER_SIMPLE_FALLBACK_BUF_SIZE (3*1024)  // 3*1024 57600
